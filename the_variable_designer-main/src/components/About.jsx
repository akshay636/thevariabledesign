...
import { address, bulb, buy, who } from "../assets/images";
  ...
  return (
    <>
      <div className="aboutPage">
        ...
        <hr />
        <div className="aboutDescriptionContainer1">
        <div className="aboutImg">
            <img src={buy} alt="" />
          </div>
          <div className="aboutHeading1">
            <h3>{AboutPageStrings.resons}</h3>
          </div>
          <div className="aboutDescription1">
            <p>{AboutPageStrings.buyDetails}</p>
            <p>{AboutPageStrings.buyDetails1}</p>
          </div>
